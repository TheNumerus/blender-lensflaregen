...
class LensFlareProperties(bpy.types.PropertyGroup):
    ...
    flare_size: bpy.props.FloatProperty(name="Flare Size", description="Flare size relative to image size", default=10.0, min=0.0)
    flare_rays: bpy.props.BoolProperty(name="Flare Rays", description="Render rays coming from light source", default=False)
    rays_intensity: bpy.props.FloatProperty(name="Rays Intensity", default=1.0, min=0.0)
    flare_intensity: bpy.props.FloatProperty(name="Flare Intensity", default=1.0, min=0.0)
